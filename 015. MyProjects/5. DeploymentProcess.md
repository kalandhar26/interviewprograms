...
- Jenkins/GitHubActions executed **mvn clean package** to **compile the code and generate a JAR** file using Maven.
...
- Upon successful tests, Jenkins/GitHubActions built a **Docker image** for each microservice using a **Multi-stage
  Dockerfile**.
